...
class Parameter:
    ...
    _elem2mass= {'H':1.00797, 'He':4.00260, 'Li':6.941, 'Be':9.01218, 'B':0.81,
                 'C':2.011, 'N':14.0067, 'O':5.9994, 'F':18.998403, 'Ne':20.179,
                 'Na':22.98977, 'Mg':24.305, 'Al':26.98154, 'Si':28.0855, 'P':30.97376,
                 'S':2.06, 'Cl':35.453, 'Ar':39.948, 'K':39.0983, 'Ca':40.08,
                 ...
                 'Kr':83.80, 'Rb':85.4678, 'Sr':87.62, 'Y':8.9059, 'Zr':91.22,
                 'Nb':92.9064, 'Mo':95.94, 'Tc':98, 'Ru':101.07, 'Rh':102.9055,
                 'Pd':106.4, 'Ag':107.868, 'Cd':112.41, 'In':114.82, 'Sn':69,
                 'Sb':121.75, 'I':26.9045, 'Te':127.60, 'Xe':131.30, 'Cs':132.9054,
